...
public class Roames_DataGrid_Std_TC004_Navigation_From_AssetModel_To_Span extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC004_Navigation_From_AssetModel_To_Span(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		taskPortalHomePage.navFromAMtoSpanNVerifySpanTotal(dataGridName, Integer.valueOf(data.get("rowNumber")));
	}	
