...
public class Roames_DataGrid_Std_TC004_Navigation_From_VZ_Bay_To_Intrusion extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC004_Navigation_From_VZ_Bay_To_Intrusion(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		taskPortalHomePage.navFromVZBaytoIntrusionNVerifyIntrusionTotal(dataGridName, Integer.valueOf(data.get("rowNumber")));
	}	
