...
public class Roames_DataGrid_Std_TC004_Navigation_From_VZ_To_Bay extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC004_Navigation_From_VZ_To_Bay(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		taskPortalHomePage.navFromVZtoBAYNVerifyBAYTotal(dataGridName, Integer.valueOf(data.get("rowNumber")));
	}	
