...
public class Roames_DataGrid_Std_TC004_Navigation_From_AssetModel_To_Pole extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC004_Navigation_From_AssetModel_To_Pole(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		// To check the poles number in Pole Grid and AssetModel Grid
		taskPortalHomePage.navFromAMtoPoleNVerifyPoleTotal(dataGridName, Integer.valueOf(data.get("rowNumber")));
	}	
