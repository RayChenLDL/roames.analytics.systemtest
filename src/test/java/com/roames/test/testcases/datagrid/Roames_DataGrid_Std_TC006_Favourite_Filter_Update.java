...
public class Roames_DataGrid_Std_TC006_Favourite_Filter_Update extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC006_Favourite_Filter_Update(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		// Update the 1st new favorite		
		objGridPageTopFilter.selectMultipleOptionsByVisibleText(options_ext);
		taskGridPageFavoriteDropDown.updateFavourite(favoriteName_1st, favoriteName_1st);
		...
		// To check the filter for the 1st new favorite
		pageTopFilter = filter_column + " is \"" + value1 + " or " + value2 + " or " + value3 + "\"";
		pu.verifyPresenceOfActiveFilter(pageTopFilter);
