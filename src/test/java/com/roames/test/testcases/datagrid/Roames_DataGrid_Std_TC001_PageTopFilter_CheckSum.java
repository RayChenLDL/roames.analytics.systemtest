...
public class Roames_DataGrid_Std_TC001_PageTopFilter_CheckSum extends TestcaseBase {
	...
	public void roames_DataGrid_Std_TC001_PageTopFilter_CheckSum(Hashtable<String,String> data, ITestContext testContext) throws Exception {
		...
		String Filter_DisplayName = data.get("Filter_Name_" + testingEnv);	
		...
		// Turn on the pagination		
		taskPortalHomePage.showPagination();
		taskPortalHomePage.checkPageTopFilter(Filter_DisplayName, Filter_ngReflectName, false);	
	}	
